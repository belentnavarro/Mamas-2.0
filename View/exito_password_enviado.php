            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 col-md-10">
                    <div class="card mb-0 shadow">
                        ...
                        <div class="card-body">
                            <p class="h4 mb-4">Correo enviado</p>
                            <p>Se ha enviado una nueva contraseña al correo.</p>
                            <p>Por favor, vuelva a introducir su email con la nueva contraseña para iniciar sesión. Gracias.</p>
                        </div>
                    </div>
                    <div class="row mt-3">
